...
result_period3top100 <- siena07(multiAlg3, data = multidata_trial3, nbrNodes=20, effects = multieff3)
xtable(result_period3top100, file="result_period3top100.htm", type="html")
