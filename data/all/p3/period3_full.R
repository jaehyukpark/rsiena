...
result_period3full <- siena07(multiAlg3, data = multidata_trial3, nbrNodes=20, effects = multieff3)
xtable(result_period3full, file="result_period3full.htm", type="html")
