...
multieff2 <- includeEffects(multieff2, between, name="marketnetwork2")
multieff2 <- includeEffects(multieff2, between, name="pronetwork2")
...
result_period2full_between <- siena07(multiAlg2, data = multidata_trial2, nbrNodes=20, effects = multieff2)
xtable(result_period2full_between, file="result_period2full_between.htm", type="html")
