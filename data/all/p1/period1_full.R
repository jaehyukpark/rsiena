...
result_period1full <- siena07(multiAlg1, data = multidata_trial1, nbrNodes=20, effects = multieff1)
xtable(result_period1full, file="result_period1full.htm", type="html")
